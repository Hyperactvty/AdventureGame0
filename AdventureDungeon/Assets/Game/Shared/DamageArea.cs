...
// {
    public class DamageArea : MonoBehaviour
    {
        ...
        public void InflictDamageInArea(float damage, bool isCritical, Vector3 center, LayerMask layers,
            QueryTriggerInteraction interaction, GameObject owner)
        {
            ...
            foreach (Damageable uniqueDamageable in uniqueDamagedHealths.Values)
            {
                ...
                uniqueDamageable.InflictDamage(
                    damage * DamageRatioOverDistance.Evaluate(distance / AreaOfEffectDistance), /* Maybe False */ isCritical, true, owner);
            }
        }
